...
class MaxPressureAgent(Agent):
    ...
    def choose_action(self, count, state):
        ...
        if state['coming_vehicle'][12] == -1:
            print("==== Miss East ====")
            phase_1 = max((np.sum(state['coming_vehicle'][0:3]) - \
                           np.sum(state['leaving_vehicle'][0:3])), 0)
            ...
            phase_3 = max((np.sum(state['coming_vehicle'][0:3]) - \
                           np.sum(state['leaving_vehicle'][0:3])), 0)
            phase_4 = max((np.sum(state['coming_vehicle'][27:30]) - \
                           np.sum(state['leaving_vehicle'][27:30])), 0)
        ...
        if state['coming_vehicle'][3] == -1:
            print("==== Miss West ====")
            phase_1 = max((np.sum(state['coming_vehicle'][9:12]) - \
                           np.sum(state['leaving_vehicle'][9:12])), 0)
            phase_2 = max((np.sum(state['coming_vehicle'][21:24]) + np.sum(state['coming_vehicle'][30:33]) - \
                           np.sum(state['leaving_vehicle'][21:24]) - np.sum(state['leaving_vehicle'][30:33])), 0)
            phase_3 = max((np.sum(state['coming_vehicle'][9:12]) - \
                           np.sum(state['leaving_vehicle'][9:12])), 0)
            phase_4 = max((np.sum(state['coming_vehicle'][18:21]) - \
                           np.sum(state['leaving_vehicle'][18:21])), 0)
        ...
        if state['coming_vehicle'][21] == -1:
            ...
            phase_2 = max((np.sum(state['coming_vehicle'][27:30]) - \
                           np.sum(state['leaving_vehicle'][27:30])), 0)
            phase_3 = max((np.sum(state['coming_vehicle'][9:12]) - \
                           np.sum(state['leaving_vehicle'][9:12])), 0)
            phase_4 = max((np.sum(state['coming_vehicle'][27:30]) - \
        ...
        if state['coming_vehicle'][30] == -1:
            print("==== Miss South ====")
            phase_1 = max((np.sum(state['coming_vehicle'][3:6]) + np.sum(state['coming_vehicle'][12:15]) - \
                           np.sum(state['leaving_vehicle'][3:6]) - np.sum(state['leaving_vehicle'][12:15])), 0)
            phase_2 = max((np.sum(state['coming_vehicle'][18:21]) - \
                           np.sum(state['leaving_vehicle'][18:21])), 0)
            phase_3 = max((np.sum(state['coming_vehicle'][0:3]) - \
                           np.sum(state['leaving_vehicle'][0:3])), 0)
            phase_4 = max((np.sum(state['coming_vehicle'][18:21]) - \
