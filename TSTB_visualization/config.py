...
#from baseline.fixedtime_green_agent import FixedtimeGreenAgent
from baseline.formula_agent import FormulaAgent
from baseline.maxpressure_agent import MaxPressureAgent
#from baseline.maxpressure_green_agent import MaxPressureGreenAgent
...
from MyLight_agent import MyLightAgent
...
DIC_EXP_CONF = {
    ...
    "LIST_MODEL_NEED_TO_UPDATE":
        ["Deeplight", "SimpleDQN", "CoLight","GCN", "SimpleDQNOne","Lit","MyLight"],
    "MODEL_POOL": False,
    "NUM_BEST_MODEL": 3,
    "PRETRAIN": True,
    #预训练使用Random,10个回合，10个生成器
...
dic_traffic_env_conf = {
    ...
    "DIC_FEATURE_DIM": dict(
       ...
       #D_VEHICLE_ACCELERATION_IMG=(4, 60,), 
        D_VEHICLE_WAITING_TIME_IMG=(4, 60,),
        D_VEHICLE_SPEED_IMG=(4, 60,),
        
        D_LANE_NUM_VEHICLE=(4,),
        D_LANE_NUM_VEHICLE_BEEN_STOPPED_THRES1=(4,),
       #D_LANE_NUM_VEHICLE_BEEN_STOPPED_THRES01=(4,),
        D_LANE_QUEUE_LENGTH=(4,),
        
       #D_LANE_NUM_VEHICLE_LEFT=(4,),
       #D_LANE_SUM_DURATION_VEHICLE_LEFT=(4,),
...
######################################################
    "LIST_STATE_FEATURE": [
        ...
        #新增特殊车辆信息
        "lane_num_sp_vehicle",
        "lane_sum_sp_vehicle_waiting_count",
        "sp_vehicle_pressure",
    ],
...
DIC_MAXPRESSUREGREEN_AGENT_CONF = {
    100: [3, 3],
    200: [3, 3],
    300: [7, 7],
    400: [12, 12],
