...
class Pipeline:
    ...
    def run(self, multi_process=False):
        ...
        # train和pretrain之间的区别是什么？？pretain主要用来收集数据填满memory,
        #这里for每一个round
        for cnt_round in range(self.dic_exp_conf["NUM_ROUNDS"]):
            ...
            #         p.join()
            # else:
            model_test.test(self.dic_path["PATH_TO_MODEL"], cnt_round, self.dic_exp_conf["RUN_COUNTS"], self.dic_traffic_env_conf, self.dic_path["PATH_TO_WORK_DIRECTORY"], if_gui=False)
            ...
            #
            #     #model.pkl包含以下信息,推测为s, a, s', r 的相关转移？？
            #     """
            #   [  {'cur_phase': [1, 0, 1, 0, 0, 0, 0, 0],
            #       'lane_num_vehicle': [0, 15, 0, 0, 6, 0, 0, 2, 0, 0, 0, 0],
            #       'adjacency_matrix': [16, 15, 17, 10, 22],
            #       'adjacency_matrix_lane': [[[121, 131, 126, -1, -1], [213, 214, 215, -1, -1]],
            #                                 ...
            #                                 [[180, 190, 185, -1, -1], [264, 265, 266, -1, -1]]]
            #      },
            #
            #     2,
            #
            #     {'cur_phase': [1, 0, 1, 0, 0, 0, 0, 0],
            #      'lane_num_vehicle': [0, 16, 0, 0, 6, 0, 0, 2, 0, 0, 0, 0],
            #      'adjacency_matrix': [16, 15, 17, 10, 22],
            #      'adjacency_matrix_lane': [[[121, 131, 126, -1, -1], [213, 214, 215, -1, -1]],
            #                                ...
            #                                [[180, 190, 185, -1, -1], [264, 265, 266, -1, -1]]]
            ...
            #         flag = 0
            #         #当随机到的ind_bar值与ind相等且flag<10时，flag+1，>10跳出？？
            ...
            # f_time = open(os.path.join(self.dic_path["PATH_TO_WORK_DIRECTORY"],"{0}_running_time.csv".format(self.dic_traffic_env_conf["MODEL_NAME"])),"a")
